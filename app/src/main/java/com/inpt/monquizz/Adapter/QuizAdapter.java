package com.inpt.monquizz.Adapter;
...
public class QuizAdapter extends RecyclerView.Adapter<QuizAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        Glide.with(holder.itemView.getContext()).load(quizModelList.get(position).getImage()).placeholder(R.drawable.placeholder_image).centerCrop().into(holder.imageView);
    }
