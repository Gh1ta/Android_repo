...
import com.inpt.monquizz.Model.QuestionModel;
...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    private void submitResult() {
        ...
        firebaseFirestore.collection("QuizList").document(quizid).collection("Results").document(currentUserId).set(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    QuizFragmentDirections.ActionQuizFragmentToResultFragment actions = QuizFragmentDirections.actionQuizFragmentToResultFragment();
