package com.inpt.monquizz.Fragment;
...
import com.inpt.monquizz.Dao.QuizViewModel;
import com.inpt.monquizz.Model.QuizModel;
import com.inpt.monquizz.R;
...
public class DetailFragment extends Fragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getLiveDatafromFireStore().observe(getViewLifecycleOwner(), new Observer<List<QuizModel>>() {
            ...
            public void onChanged(List<QuizModel> quizModels) {
                ...
                Glide.with(getContext()).load(quizModels.get(position).getImage()).placeholder(R.drawable.placeholder_image).centerCrop().into(imageView);
    ...
    private void LoadRECENTResult() {
        ...
        if (user != null) {
            ...
            firebaseFirestore.collection("QuizList").document(quizID).collection("Results").document(currentUserId).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                @Override
